...
import Fees8 from '/snippets/p_body/Fees8.mdx';
import CreditedFunds from '/snippets/p_body/CreditedFunds.mdx';
import DebitedFunds from '/snippets/p_body/DebitedFunds.mdx';
import CreditedWalletId1 from '/snippets/p_body/CreditedWalletId1.mdx';
import DebitedWalletId1 from '/snippets/p_body/DebitedWalletId1.mdx';
import AuthorId4 from '/snippets/p_body/AuthorId4.mdx';
