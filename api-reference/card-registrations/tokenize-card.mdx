...
import cardCvx from '/snippets/p_body/cardCvx.mdx';
import cardExpirationDate from '/snippets/p_body/cardExpirationDate.mdx';
import cardNumber from '/snippets/p_body/cardNumber.mdx';
import data from '/snippets/p_body/data.mdx';
import accessKeyRef from '/snippets/p_body/accessKeyRef.mdx';
