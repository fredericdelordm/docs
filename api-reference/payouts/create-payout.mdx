...
import PayoutModeRequested from '/snippets/p_body/PayoutModeRequested.mdx';
import BankWireRef from '/snippets/p_body/BankWireRef.mdx';
import BankAccountId from '/snippets/p_body/BankAccountId.mdx';
import DebitedWalletId from '/snippets/p_body/DebitedWalletId.mdx';
import Fees2 from '/snippets/p_body/Fees2.mdx';
import DebitedFunds3 from '/snippets/p_body/DebitedFunds3.mdx';
import AuthorId1 from '/snippets/p_body/AuthorId1.mdx';
