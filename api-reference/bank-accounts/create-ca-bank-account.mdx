...
import Tag4 from '/snippets/p_body/Tag4.mdx';
import OwnerName from '/snippets/p_body/OwnerName.mdx';
import BankName from '/snippets/p_body/BankName.mdx';
import BranchCode from '/snippets/p_body/BranchCode.mdx';
import InstitutionNumber from '/snippets/p_body/InstitutionNumber.mdx';
import AccountNumber from '/snippets/p_body/AccountNumber.mdx';
import OwnerAddress from '/snippets/p_body/OwnerAddress.mdx';
